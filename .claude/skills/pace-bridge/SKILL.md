---
name: pace-bridge
description: Use when 已经有 Superpowers 生成的计划文件，需要把 docs/plans/ 同步桥接到 PACEflow 的 task.md 和 implementation_plan.md 时触发；也适用于出现 Superpowers 计划文件相关 DENY 或桥接提醒时，不用于普通计划编写或代码实现
---
